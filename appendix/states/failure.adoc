...
invoked from almost any Deposit state, as faults may occur during any other
...
=== `notifyCourtesyCall`
* Anyone may notify the contract that it is undercollateralized
* *access controls*
** anyone
* *reads*
** ORACLE
