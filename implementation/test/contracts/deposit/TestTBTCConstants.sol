...
library TestTBTCConstants {
    ...
    // System Parameters
    uint256 public constant LOT_SIZE_BTC = 1000; // satoshi TODO: decreased for testing, set it back original value `10 ** 8`
    uint256 public constant LOT_SIZE_TBTC = LOT_SIZE_BTC * 10 ** 10; // TBTC TODO: decreased for testing, set it back original value `10 ** 18`    uint256 public constant BENEFICIARY_FEE_DIVISOR = 1000;  // 1/1000 = 10 bps = 0.1% = 0.001
    ...
    function getLotSizeTbtc() public pure returns (uint256) { return LOT_SIZE_TBTC; }
