...
contract Deposit is OutsourceDepositLogging {
    ...
    function createNewDeposit(
        ...
        require(DepositUtils.isApprovedDepositCreator(msg.sender), 'Calling account not allowed to create deposits');
    ...
    function signerPKH() public view returns (bytes20) {
        bytes memory _pubkey = DepositUtils.compressPubkey(signingGroupPubkeyX, signingGroupPubkeyY);
    ...
    function provideRedemptionProof(
        ...
        (_txid, _outs) = DepositUtils.RedemptionProofChecks(
            _bitcoinTx,
            _merkleProof,
            _index,
            _bitcoinHeaders,
        ...
        //require here becuase stack too deep otherwise
    ...
    function provideFraudBTCFundingProof(
        ...
        (_valueBytes, _outpoint) = DepositUtils.validateAndParseFundingSPVProof(_bitcoinTx, _merkleProof, _index, _bitcoinHeaders, signerPKH());
    ...
    function provideSPVFraudProof(
        ...
        DepositUtils.SpvFraudProofHelper( _bitcoinTx, _merkleProof, _index, _bitcoinHeaders, requesterPKH, utxoOutpoint, initialRedemptionFee, utxoSize());
