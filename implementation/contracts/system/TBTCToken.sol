...
contract TBTCToken is ERC20Detailed, ERC20, MinterAuthority {
    ...
    function mint(address _account, uint256 _amount) public isApproved returns (bool){
    ...
    function burnFrom(address _account, uint256 _amount) public isApproved {
    ...
    function transferFrom(address _from, address _to, uint256 _value) public isApproved returns (bool) {
