...
pre-liquidation, also referred to as “courtesy call”. Pre-liquidation indicates
that the signers should close the deposit or face forced liquidation after a
