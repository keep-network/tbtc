...
against the bonded asset translates to lower fees for Signers. Note that this
...
points on a $10,000 deposit for $15,000 of collateral (0.05% of $10,000): $5.
...
:fraudulent-signature: footnote:[signatures not explicitly authorized by the \
tBTC system are considered fraudulent. The system only authorizes redemption \
...
* In case of liquidation due to **fraud**, the remaining bond value goes
