...
The contract owner may update the collateralization thresholds for new deposits
after a 2 day delay.
...
The contract owner may add a new backup ETHBTC price feed for all deposits
after a 90 day delay. Note that this delay is significantly longer than other
governance controls.
