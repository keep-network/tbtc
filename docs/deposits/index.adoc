...
at least 1 BTC lot sizes will be available. v1 will launch with six available
...
create multiple deposit requests and fund multiple deposits. Note that available
deposit lot sizes are one of the aspects of tBTC v1 that are governable.
