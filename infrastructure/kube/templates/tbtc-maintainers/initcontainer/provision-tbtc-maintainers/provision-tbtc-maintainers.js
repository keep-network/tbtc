...
*/
const mockRelayJsonFile = '/tmp/MockRelay.json';
const mockRelayParsed = JSON.parse(fs.readFileSync(mockRelayJsonFile));
const mockRelayContractAddress = mockRelayParsed.networks[ethNetworkId].address;
...
async function createTbtcMaintainersConfig() {
  ...
  console.log("MockRelay contract address:", mockRelayContractAddress)
  parsedConfigFile.ethereum.ContractAddresses.MockRelay = mockRelayContractAddress;
